#
# Be sure to run `pod lib lint PHBStackLayout.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of PHBStackLayout.'
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'PHBStackLayout/Classes/**/*'
  
  # s.resource_bundles = {
  #   'PHBStackLayout' => ['PHBStackLayout/Assets/*.png']
  # }
